...
export const recipes = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { key: "lemon", item: "lemon", amount: 1, unit: "", category: "Produce", quantification: { status: "needs-juice-grams", reason: "Keep one lemon for shopping; record actual juice used in grams for nutrition." }, nutritionLookup: { source: "USDA FoodData Central", query: "lemon juice raw", fdcId: 167747, dataType: "SR Legacy", status: "matched" } }, { key: "olive-oil", item: "California Olive Ranch Extra Virgin Olive Oil", amount: 2, unit: "tbsp", grams: 27, category: "Pantry", pantry: true, productRegistryKey: "olive-oil", quantification: { status: "quantified", gramsPerTablespoon: 13.5 }, nutritionLookup: { source: "USDA FoodData Central", query: "olive oil", fdcId: 748608, dataType: "Foundation", status: "matched", note: "Generic olive-oil nutrient record is acceptable for the preferred pure EVOO; brand remains the shopping default." } },
    ...
    portions: { alisa: "Generated from Alisa's active nutrition target", mom: "Generated separately from Mom's nutrition target" }, portionStrategy: { mode: "nutrition-target", fixedCupServing: false, flavorContract: "Scale cucumber, carrot, herbs, lemon juice, and EVOO together as one dressed-salad component so the salad does not become underdressed when portions change." }, storage: "Keep vegetables and dressing separate for up to 3 days.", nutrition: nutritionPending,
  },
  {
